...
def banner():
    print("""\033[36m
        ...
        |_|  \___/|_|  \__,_|____/| .__/|_|\__,_|\___|_|
                                  |_|                   \033[0m                             
         #                                  \033[35mby B1ue Blog:b1ue.top\033[0m              
    """)
...
def Cmd():
    ...
    parser.add_option('-r',dest='source',help='Your txt Path')  
...
class FofaSpider(object):
    ...
    def spider(self):
        ...
        try:
            ...
            #sys.stdout.write('\033[0m\033[31m\结果存储在{}.txt\n\n\033[0m'.format(spider.name, spider.name))
...
if __name__ == '__main__':
    ...
    #your_cookie = str(input("\033[35mPlease input your_cookie\nUrl   >>> \033[0m"))
    #在'''cookie'''中添加自己的cookie即可！
    cookie = '''  1  '''
    ...
    try:
        ...
        print("\n\033[31m[!]用户退出\033[0m\n")
        sys.stdout.write('\033[0m\033[31m\结果存储在t{}.txt\n\n\033[0m'.format(spider.name,spider.name))
